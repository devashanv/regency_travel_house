...
function NavBar1(prop) {
  ...
  return (
    <>
      <div className="absolute h-50 z-[-1] top-0 left-0 w-full bg-gradient-to-b from-white/70 via-white/30 to-transparent"></div>
                ...
                <div className="w-4/6 flex justify-between">
                  ...
                  <div className="w-1/5 flex flex-col items-center ">
                    ...
                    <div className="grid grid-cols-2 gap-10 lg:gap-6 lg:w-auto">
                      ...
                      <div className="flex flex-col gap-3 text-lg font-thin lg:w-auto">
                        <Link
              ...
              <button
                className={
                  prop.page === "signin" || prop.page === "signup"
                    ? "hidden"
                    : "block w-20 bg-primary rounded-full cursor-pointer text-white text-sm py-2 hover:bg-secondary transition"
                }
              >
                Sign In
              </button>
