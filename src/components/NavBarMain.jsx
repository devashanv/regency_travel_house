...
function NavBarMain(prop) {
  ...
  return (
    <>
      ...
      <nav className="w-full text-body top-0 z-90 text-para flex justify-between px-5 py-3 lg:px-10 lg:py-2">
        {/* logo */}
        <div className="w-2/3 flex lg:w-1/5 lg:flex">
          <img
            src="../../public/RTH-logo.png"
          ...
          >
            ...
            <li className="group hidden items-center lg:flex  h-full">
              ...
              <ul className="absolute pt-11 pb-11 m w-full flex   justify-center top-18 left-0 hidden group-hover:flex flex-row z-50  bg-white/30 backdrop-blur-md text-sm shadow-xl rounded-lg py-6 px-8 gap-10 transition transition-all duration-800 ease-out">
                <div className=" w-[300px] mt-[-50px]  rotate-">
                ...
                <div className="w-4/6 flex justify-between">
                  ...
                  <div className="w-1/5 flex flex-col items-center">
                    <Link
                      className="text-gray-800 font-semibold mb-4 text-xl hover:text-secondary"
                  ...
                  <div className="w-1/5 flex flex-col items-center ">
                    ...
                    <div className="flex justify-center items-center mt-4 w-full text-lg font-thin">
                      <Link
                  ...
                  <div className="flex flex-col gap-3 text-base font-thin">
                    ...
                    <Link
                      to="/destination-packages?country=switzerland"
                      className="hover:text-secondary"
                    >
                      Switzerland
                    </Link>
                    <Link
                      to="/destination-packages?country=spain"
                      className="hover:text-secondary"
                    >
                      Spain
                    </Link>
                  ...
                  <div className="flex flex-col gap-3 text-base font-thin">
                    ...
                    <Link
                      to="/destination-packages?country=morocco"
                      className="hover:text-secondary"
                    >
                      Morocco
                    </Link>
                    <Link
                      to="/destination-packages?country=tunisia"
                      className="hover:text-secondary"
                    >
                      Tunisia
                    </Link>
                    <Link
                      to="/destination-packages?country=algeria"
                      className="hover:text-secondary"
                    >
                      Algeria
                    </Link>
                    <Link
                      to="/destination-packages?country=libya"
                      className="hover:text-secondary"
                    >
                      Libya
                    </Link>
        ...
        <div
          className={`lg:hidden bg-white/0.8 backdrop-blur-2xl fixed top-0 text-primary right-0 h-full w-3/4 bg-white shadow-lg z-50 transform transition-transform duration-300 ease-in-out ${
                ...
                {showDestinations && (
                  <ul className="mt-2 ml-2 flex flex-col gap-2 text-base text-gray-700">
                    <li className="hover:bg-white px-4 py-2 rounded-xl">
                      <Link
                        to="/destination-packages?region=south-asia"
                        onClick={openMenu}
                      >
                        South Asia
                      </Link>
                    ...
                    <li className="hover:bg-white px-4 py-2 rounded-xl">
                      <Link
                        to="/destination-packages?region=southeast"
                        onClick={openMenu}
                      >
                        East Asia
                      </Link>
                    ...
                    {/* <li className="hover:bg-white px-4 py-2 rounded-xl">
                      <Link
                        to="/destination-packages?region=middle-east"
                        onClick={openMenu}
                      >
                        Middle East
                      </Link>
