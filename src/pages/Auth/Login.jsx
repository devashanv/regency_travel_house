...
const Login = () => {
  ...
  return (
    <div>
      <button
        className="hidden lg:block absolute cursor-pointer lg:mt-5 ml-15 lg:ml-50 px-4 py-2 border border-blue-500 text-blue-600 rounded-full hover:border-[#0D1537] hover:text-[#0D1537]"
        onClick={() => navigate("/")}
      >
        Back
      </button>
      <div className="mx-auto my-30 flex h-[70vh] lg:w-3/4 lg:shadow-xl">
        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-10 bg-white">
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-80 py-3 rounded-full  cursor-pointer font-semibold shadow-md transition-all ${
                loading
          ...
          <div className="mt-6 flex flex-col items-center justify-center text-sm text-center">
            ...
            <button
              ...
              className="mt-3 px-4 py-2 border  cursor-pointer border-pink-500 text-pink-600 rounded-full hover:border-[#0D1537] hover:text-[#0D1537]"
            >
              CREATE NEW
            </button>

            <button
              className="mt-3 px-4 py-2 border  cursor-pointer border-blue-500 text-blue-600 rounded-full hover:border-[#0D1537] hover:text-[#0D1537] lg:hidden"
              onClick={() => navigate("/")}
            >
              Back
            </button>
